<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0a66c2&height=200&section=header&text=Gabriel+%C2%B7+Cipriano&fontSize=60&fontAlignY=38&fontColor=ffffff&desc=Full-Stack%20Developer%20·%20M%C3%A9xico&descAlignY=60&descSize=18&animation=fadeIn" alt="Header" />
</p>
...
- **PaperSheet** — Workshop management platform. Appointment scheduling, vehicle reception, and service order flows. Built with React, TypeScript, Vite, and AWS Amplify Gen 2.
- Deepening AWS expertise — Amplify Gen 2, AppSync, DynamoDB, Lambda, Cognito.
- Architecting permission systems and gamified UX patterns for non-technical users.
...
- **Architecture first.** I think in systems before I write code.
- **Consistency over intensity.** I ship steadily, every week.
- **Product-minded.** I ask *why* before I build *what*.
- **Mentorship-driven.** I've led small teams and onboarded interns — clarity scales better than cleverness.

### 🤝 Let's talk

<p>
  <a href="https://www.linkedin.com/in/gabrielciprianoo/">
